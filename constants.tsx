...
export const ANNOUNCEMENTS_BN = [
  "ভোট দিন খিচুড়ি মার্কায়, পকেট ভরুন রঙিন ধোঁয়ায়! 💨",
  ...
  "খিচুড়ি মার্কায় ভোট দিলে মিলবে চাঁদে জমি কেনার অগ্রিম সুযোগ! 🌙"
];
...
export const LEADERS: Leader[] = [
  {
    id: "1",
    name: "জনাব আলহাজ্ব মতিউর ম্যাট্রিক্স",
  ...
  },
  {
    ...
    promise: "আলাদা ভাবে অন্যদের ভোট না দিয়ে গণ-খিচুড়ি মার্কায় ভোট দিন। যেখানে একের ভেতর সব",
    image: "https://picsum.photos/seed/zahidazad/400/400",
    bio: "তিনি মনে করেন সব দলের ভাল-মন্দ মিশিয়ে একটি সুস্বাদু খিচুড়ি শাসন ব্যবস্থা গড়ে তোলা সম্ভব। তার নেতৃত্বে গদি বিলাস হবে আরও আনন্দদায়ক।"
  }
];
