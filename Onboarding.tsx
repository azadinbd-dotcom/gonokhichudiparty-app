...
const STEPS = [
  {
    ...
    desc: "আমরা আধুনিক প্রযুক্তির মাধ্যমে আপনাদের মূল্যবান গণতান্ত্রিক সম্পদের সঠিক মূল্যায়ন নিশ্চিত করছি।",
    useLogo: true
  },
  {
    title: "ভোট বিক্রি করুন নিরাপদে",
    desc: "বাজারদরের সাথে তাল মিলিয়ে আমরা দিচ্ছি সর্বোচ্চ মূল্য। আপনার মূল্যবান ভোটটি পলিটিক্যাল সালাদ মার্কায় গচ্ছিত রাখুন।",
    icon: "💸"
  },
  {
    title: "গদি বিলাস জিন্দাবাদ",
    desc: "মিথ্যা আশ্বাস আর কাল্পনিক ইশতেহারের মহাসড়কে আপনাকে আমন্ত্রণ। আমাদের পলিটিক্যাল সালাদ মার্কায় যা আছে, তা আপনি কল্পনাও করতে পারবেন না!",
    icon: "🚀"
  }
];
